...
public final class MobCustomizationListener implements Listener {
    ...
    private void applyProfile(Entity entity, DimensionPreset.MobProfile profile) {
        ...
        if (profile.scale != 1.0) {
            // Attribute.SCALE - added in 1.20.5, renamed from GENERIC_SCALE in the 1.21
            // attribute-key rework (minecraft:generic.scale -> minecraft:scale). Confirmed
            // against the real paper-api 1.21.4 jar - see CHANGES.md.
